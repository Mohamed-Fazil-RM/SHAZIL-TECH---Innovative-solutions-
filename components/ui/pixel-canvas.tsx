...
// Removed the global JSX augmentation that was shadowing standard HTML elements.
// The custom element is handled via 'as any' casting in the component below.
...
const PixelCanvas = React.forwardRef<HTMLDivElement, PixelCanvasProps>(
  ({ gap, speed, colors, variant, noFocus, style, ...props }, ref) => {
    // Custom element tag handled as any to avoid global JSX namespace issues
    const Tag = "pixel-canvas" as any;
    React.useEffect(() => {
